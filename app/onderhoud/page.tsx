...
import { Users, Car, StickyNote, TrendingUp } from "lucide-react"
    ...
    <div className="flex h-screen bg-background">
      ...
      <main className="w-[calc(100%-16rem)] flex-shrink-0 overflow-y-auto bg-gray-50/50 dark:bg-gray-900/50">
        <div className="h-full">
          ...
          <div className="space-y-8 pl-8 pt-8">
              ...
              <Card className="hover:shadow-lg transition-shadow">
                ...
                <CardContent>
                  <div className="space-y-4">
                    {[
                      "APK - VanDijck Juno",
                      "Bandenwissel - Muon Ease",
                      "Grote beurt - Muon Strive",
                      "Inspectie - Muon Ease",
                    ].map((item, index) => (
                      <div
                        key={index}
